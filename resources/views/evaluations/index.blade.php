        ...
        <div class="bg-white shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('evaluations.create') }}" class="px-4 py-2 btn-primary">
                ...
                <div class="mb-6">
                    <form method="GET" action="{{ route('evaluations.index') }}"
                        ...
                        <!-- Search -->
                        <div>
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari instansi..."
                                class="input-custom">
                        </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-xs text-gray-600">{{ $evaluation->getCompletionPercentage() }}%</span>
                                        </div>
                                    </td>
