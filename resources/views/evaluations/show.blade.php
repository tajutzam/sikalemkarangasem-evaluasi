                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div class="text-right">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-600">
                                    Progress: <span
                                        class="font-semibold">{{ $evaluation->getCompletionPercentage() }}%</span>
                                </p>
                            ...
                            <div class="mb-4">
                                ...
                                @if($detail->buktiDokumen->count() > 0)
                                    <p class="text-xs text-gray-500 mb-2">
                                        Total {{ $detail->buktiDokumen->count() }} file terlampir:
                                    </p>
                                            ...
                                            <div class="p-3 bg-white border border-gray-200 rounded-md flex items-center justify-between"
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    @if($evaluation->canBeEdited())
                                                        <button type="button" onclick="deleteSingleFile({{ $bukti->id }})"
                                ...
                                @else
                                    <p class="text-sm text-gray-500 italic">Tidak ada file bukti.</p>
                                @endif
                            </div>
                    ...
                    @if(Auth::user()->is_admin && $evaluation->isSubmitted())
                        <div class="space-x-4">
                            <form action="{{ route('evaluations.reject', $evaluation) }}" method="POST"
                                onsubmit="return confirm('Apakah Anda yakin ingin menolak lembar kerja ini?');" class="inline">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
